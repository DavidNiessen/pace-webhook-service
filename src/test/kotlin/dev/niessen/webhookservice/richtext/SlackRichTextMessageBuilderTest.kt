...
class SlackRichTextMessageBuilderTest {
    ...
    private val slackRichTextMessageBuilder = SlackRichTextMessageBuilder(
        "v1.0.0", IconUtil(
            IconProperties(
                mapOf(
        ...
        ), ApiMockHelper.mockTimeUtils(LocalDate.of(2025, 9, 12))
    )
